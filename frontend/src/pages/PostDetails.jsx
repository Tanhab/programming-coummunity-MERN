        ...
        <div className="card-content">
          <div className="card-body p-0">
            ...
            <div className="profile">
              {author.image ? <img src={author.image} /> : <img src={UserImage} />}
            </div>
            ...
            <div className=" flex-row align-items-start">
                <form >
                    <div className="flexContainer">
                        <input type="text" style={{width:'100%', height:'40px'}} autoFocus id="commentBody"  placeholder="Comment here" required/>
                            
                    </div>
                    <div className="text-right">
                        <button className="comment_button" type="submit" value="Comment">
                            Post comment
                        </button>
                    </div>
